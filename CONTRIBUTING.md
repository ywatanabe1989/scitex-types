...
- Search [existing issues](https://github.com/ywatanabe1989/scitex-types/issues)
  before opening a new one.
- Include a minimal reproducible example when reporting bugs.
- Specify your Python version, OS, and `scitex-types` version.

## Development Setup

```bash
git clone git@github.com:ywatanabe1989/scitex-types.git
cd scitex-types
pip install -e ".[dev]"
```
