...
# (project=scitex-types, owner=ywatanabe1989, repo=scitex-types,
...
TMPDIR="/tmp/publish-scitex_types-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-types dist/* uploaded to PyPI via manual OIDC trusted publishing"
