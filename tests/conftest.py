...
because pytest-cov has already set COVERAGE_FILE to a tmp dir by
the time conftest is loaded — so we force-set.
"""
...
def _ensure_subprocess_coverage_shim() -> None:
    ...
    pth = purelib / "_scitex_types_subprocess_coverage.pth"
    shim = (
        "import os, coverage\n"
